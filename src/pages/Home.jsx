...
function Home() {
    ...
    const [isMediumDevice, setIsMediumDevice] = useState(window.innerWidth > 1450); // State for medium devices
    ...
    useEffect(() => {
        ...
        // Update `isMediumDevice` on window resize
        const handleResize = () => setIsMediumDevice(window.innerWidth > 1450);
        ...
        <div className='w-full py-8 bg-white-50 bg-gradient-to-br from-[#e8dfff] to-[#ffebff] h-[100vh]'>
            <Container>
                <div className='flex flex-wrap -mx-4'>
                    {isMediumDevice && ( // Conditionally render for medium and larger devices
                        <>
                            <motion.div
                                className="popup-box"
                                style={{
